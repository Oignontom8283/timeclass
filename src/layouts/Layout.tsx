...
export default function Layout() {
  return (
    <div className="min-h-screen flex flex-col">
      <header className="w-full h-12 flex items-center justify-between border-b border-gray-300 bg-zinc-50">
        ...
        {/* Right */}
        <div>
          <Link to="https://github.com/Oignontom8283/timeclass" target="_blank" className='flex flex-row items-center justify-center gap-2 mr-4' title='Come help build something great !'>
